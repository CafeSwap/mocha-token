...
// File: contracts/WrappedMOCHA.sol

// SPDX-License-Identifier: UNLICENSED
pragma solidity 0.6.12;

contract wMOCHA is ERC20("Wrapped MOCHA", "wMOCHA") {
    ...
    uint256 public constant BURN_FEE = 900;
    uint256 public constant REWARD_FEE = 100;
    uint256 public constant MAX_FEE = 100000;

    /// @dev List of whitelisted addresses
    mapping(address => bool) public whiteList;

    // The mochaToken which is being wrapped
    IERC20 public mochaToken;
    ...
    function _transfer(
        ...
        if (whiteList[sender] == false && whiteList[recipient] == false) {
            ...
            super._transfer(
                sender,
                recipient,
                amount.sub(toBurn.add(toReward))
            );
    ...
    function setWhiteListAccount(address account, bool status)
        external
        onlyAdmin()
    {
    ...
    /**
     * @dev no need to have whitelists for conversion
     * because minting and burning does make a transfer.
     * MochaToken should have this whitelisted as well as
     * wMocha should have the Mocha contract whitelisted
     */
    function deposit(uint256 amount) external returns (bool) {
        mochaToken.safeTransferFrom(address(msg.sender), address(this), amount);
    ...
    function withdraw(uint256 amount) external returns (bool) {
        ...
        mochaToken.safeTransfer(msg.sender, amount);
